...
import mx.linkom.caseta_sanmb.adaptadores.ListasHoraFechaClassGrid;
import mx.linkom.caseta_sanmb.adaptadores.adaptador_Modulo;

public class ListaRondinesUbicacionesActivity extends mx.linkom.caseta_sanmb.Menu{

    private GridView gridList;
    private mx.linkom.caseta_sanmb.Configuracion Conf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Incidencia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.RondinIncidencias.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void horarios() {
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_2.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void rondin(final String id_rondin) {
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_3.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void ubicaciones(final String id_app) {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_4.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.RondinInfoActivity.class);
                            startActivity(i);
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.ListaRondinesActivity.class);
