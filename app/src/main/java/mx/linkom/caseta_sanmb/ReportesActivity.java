...
public class ReportesActivity extends mx.linkom.caseta_sanmb.Menu {
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            if(position==0) {
                                   Intent placas = new Intent(getApplication(), mx.linkom.caseta_sanmb.PlacasActivity.class);
                ...
                if (entrada != null) {
                    ...
                    gridList2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            if(position==0) {
                                Intent inci = new Intent(getApplication(), mx.linkom.caseta_sanmb.EscaneoTrabajadorActivity.class);
                                startActivity(inci);
                                finish();
                            }
                        }
                ...
                if (entrada != null) {
                    ...
                    gridList3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            if(position==0) {
                               Intent inci = new Intent(getApplication(), mx.linkom.caseta_sanmb.IncidenciaActivity.class);
                                startActivity(inci);
                                finish();
                            }
                        }
                ...
                if (entrada != null) {
                    ...
                    gridList4.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            if(position==0) {
                                Intent placas = new Intent(getApplication(), mx.linkom.caseta_sanmb.CorrespondenciaActivity.class);
                                startActivity(placas);
                                finish();
                            }
                        }
                ...
                if (entrada != null) {
                    ...
                    gridList5.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                           ...
                           // if(position==0) {
                            //    Intent placas = new Intent(getApplication(), mx.linkom.caseta_sanmb.ListaRondinesActivity.class);
                           //     startActivity(placas);
                           //     finish();
                           //mega }
