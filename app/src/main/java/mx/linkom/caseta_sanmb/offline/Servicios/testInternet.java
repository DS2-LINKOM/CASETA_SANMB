package mx.linkom.caseta_sanmb.offline.Servicios;
                ...
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        while (true) {
                            ...
                            try {
                                if (internet && Global_info.isOfflineActivo() == false){
                ...
                if (eliminar >= 0){
                    try {
                        ...
                        for (int i = 0; i<array.length(); i++){
                            ...
                            values.put("numero_int", object.getString("numero_int"));
