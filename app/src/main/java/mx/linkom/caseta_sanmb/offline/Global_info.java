package mx.linkom.caseta_sanmb.offline;
...
public class Global_info extends Application {
    ...
    private static boolean OFFLINE_ACTIVO = false;
    //private static String URL = "http://192.168.0.110/android/demoCaseta/";
    private static String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/off-line/";

    public static boolean isOfflineActivo() {
        return OFFLINE_ACTIVO;
    }

    public static void setOfflineActivo(boolean offlineActivo) {
        OFFLINE_ACTIVO = offlineActivo;
    }
