package mx.linkom.caseta_sanmb.offline.Database;
...
public class ContentProvider extends android.content.ContentProvider {
    ...
    public static final String AUTORIDAD = "mx.linkom.caseta_sanmb";
        ...
        switch (match){
            ...
            case LUGAR:
                if (selection.equals("numeros")){
                    ...
                    if (id_res_lugar_numeros.trim().equals("1")){
                    ...
                    Log.e("CONSULTA", "SELECT DISTINCT(calle) as nombre FROM lugar WHERE estatus=1 and id_residencial="+"'"+id_resi_lugar+"'"+" order by nombre asc");
                    ...
                    if (id_resi_lugar.trim().equals("1")){
            ...
            case DTL_ENTRADAS_SALIDAS:
                if (selection.equals("consulta1")){
                    ...
                    String id_resi_entr = selectionArgs[0];
                    String id_visita = selectionArgs[1];
                    Log.e("CONSULTA", "SELECT id,id_visita,estatus,foto1,foto2,foto3,personas,placas,sqliteEstatus FROM dtl_entradas_salidas WHERE id_visita ="+"'"+id_visita+"'"+" and id_residencial="+"'"+id_resi_entr+"'"+" ORDER BY id DESC LIMIT 1");
