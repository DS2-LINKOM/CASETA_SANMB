...
public class EntregaActivity extends mx.linkom.caseta_sanmb.Menu {
    ...
    public void check() {
        String url = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/correspondencia_5.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void check2() {
        String url = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/correspondencia_6.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void Validacion() {
        ...
        alertDialogBuilder
                ...
                .setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.cancel();
                        Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.CorrespondenciaActivity.class);
                        startActivity(i);
                        finish();
                    }
                }).create().show();
    ...
    public void Registrar(){
        ...
        String url = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/correspondencia_7.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.CorrespondenciaActivity.class);
