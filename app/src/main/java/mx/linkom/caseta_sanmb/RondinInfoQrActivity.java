...
public class RondinInfoQrActivity extends mx.linkom.caseta_sanmb.Menu {
    ...
    public void dtl_rondines (){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_qr_7.php";
    ...
    public void rondin() {
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_qr_5.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void Ubicacion(){
        ...
        try {
            ...
            if(Conf.getQRondines().equals(ja1.getString(3))){
                ...
                String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_qr_6.php";
                RequestQueue requestQueue = Volley.newRequestQueue(this);
                StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response){
                            ...
                            alertDialogBuilder
                                    ...
                                    .setPositiveButton("Ok",new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.ListaRondinesUbicacionesQrActivity.class);
                                            startActivity(i);
                                            finish();
                                        }
                                    }).create().show();
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.ListaRondinesUbicacionesQrActivity.class);
