...
import mx.linkom.caseta_sanmb.adaptadores.ModuloClassGrid;
...
import mx.linkom.caseta_sanmb.offline.Servicios.testInternet;

public class DashboardActivity extends  mx.linkom.caseta_sanmb.Menu {
    ...
    public void Registro (){
        try {
            fAuth.createUserWithEmailAndPassword(mx.linkom.caseta_sanmb.Global.EMAIL, mx.linkom.caseta_sanmb.Global.PASS)
    ...
    public void Sesion (){
        try {
            fAuth.signInWithEmailAndPassword(mx.linkom.caseta_sanmb.Global.EMAIL, mx.linkom.caseta_sanmb.Global.PASS)
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
    ...
    public void Contador(){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/contadores.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void Contador2(){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/contadoresT.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                                    if (position == 0 ){
                                        Intent docugen = new Intent(getApplication(), mx.linkom.caseta_sanmb.EntradasSalidasActivity.class);
                ...
                if (entrada != null) {
                    ...
                    gridList2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                                ...
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_sanmb.ReportesActivity.class);
                                startActivity(docugen);
                                finish();
