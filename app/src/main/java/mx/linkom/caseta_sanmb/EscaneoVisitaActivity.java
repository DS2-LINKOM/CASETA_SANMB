...
public class EscaneoVisitaActivity extends mx.linkom.caseta_sanmb.Menu {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Registro2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Conf.setPlacas("");
                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.AccesoRegistroActivity.class);
                startActivity(i);
                finish();
            }});
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("error")){
                    ...
                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.AccesosActivity.class);
                    startActivity(i);
                    finish();
                    ...
                    if(Integer.parseInt(Conf.getPreQr())==1){
                        ...
                        try {
                            ...
                            if(ja1.getString(6).length()>0) {
                                ...
                                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.EntradasQrActivity.class);
                                startActivity(i);
                                finish();
                        ...
                        try {
                            ...
                            if(ja1.getString(6).length()>0) {
                                ...
                                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.AccesosMultiplesActivity.class);
                                startActivity(i);
                                finish();
                            }else if(palabra.equals("M")){
                                Conf.setST("Aceptado");
    ...
    public void placas() {
        ...
        if (Placas.getText().toString().equals("")) {
            ...
            String url = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_reg_4.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
