...
public class EntradasQrActivity extends mx.linkom.caseta_sanmb.Menu {
                        ...
                        if (response.length() > 0) {
                            try {
                                ...
                                if (Conf.getTipoQr().equals("Normal")) {
                                    ...
                                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.PreEntradasGrupalActivity.class);
                                    startActivity(i);
                                    finish();
                                }
