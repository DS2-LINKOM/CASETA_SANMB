...
import mx.linkom.caseta_sanmb.adaptadores.ListasClassGrid;
import mx.linkom.caseta_sanmb.adaptadores.adaptador_Modulo;


public class ListaGrupalEntradaActivity extends mx.linkom.caseta_sanmb.Menu {
    ...
    public void invitados() {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_gru_1.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            if(Integer.parseInt(Conf.getPreQr())==1){
                                ...
                                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.AccesosGrupalActivity.class);
                                startActivity(i);
                                finish();
                            }
