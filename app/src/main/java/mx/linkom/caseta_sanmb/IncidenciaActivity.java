...
public class IncidenciaActivity  extends mx.linkom.caseta_sanmb.Menu{
    ...
    public void Registrar(final int Id){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/incidencias.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
