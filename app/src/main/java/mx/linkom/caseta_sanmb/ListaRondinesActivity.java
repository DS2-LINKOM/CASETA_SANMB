...
public class ListaRondinesActivity extends mx.linkom.caseta_sanmb.Menu {
    ...
    public void horarios() {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_1.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
