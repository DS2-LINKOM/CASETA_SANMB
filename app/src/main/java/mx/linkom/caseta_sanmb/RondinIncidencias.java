...
public class RondinIncidencias  extends mx.linkom.caseta_sanmb.Menu{
    ...
    public void Validacion(final int Ids) {
        ...
        alertDialogBuilder
                ...
                .setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.cancel();
                        Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.ReportesActivity.class);
                        startActivity(i);
                        finish();
                    }
                }).create().show();
    ...
    public void Registrar(final int Id){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_8.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
