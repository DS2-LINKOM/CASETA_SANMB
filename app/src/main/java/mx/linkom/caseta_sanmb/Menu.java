...
public class Menu extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener, android.widget.PopupMenu.OnMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (id == R.id.Inicio) {
            ...
            startActivity(new Intent(getBaseContext(), mx.linkom.caseta_sanmb.MainActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP));
            finish();
