...
public class VisitasRecepSalidasDetalle extends mx.linkom.caseta_sanmb.Menu {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Continuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.AccesosMorososActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void menu() {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/menu.php";
    ...
    public void submenu(final String id_app) {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/menu_2.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void Visita(){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_php1.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void Usuario(final String IdUsu){ //DATOS USUARIO
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_php2.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void dtlLugar(final String idUsuario){
        String URLResidencial = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_php3.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
    ...
    public void salidas (final String id_visitante){
        String URLResidencial = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_php6.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLResidencial, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    public void dtl_recpecion (){
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/visitas_recep_4.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    public void Registrar (){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/visitas_recep_5.php";
            ...
            public void onResponse(String response) {
                if(response.equals("succes")){
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ok",new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,int id) {
                                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.RecepcionVisitasActivity.class);
                                    startActivity(i);
                                    finish();
                                }
                            }).create().show();
