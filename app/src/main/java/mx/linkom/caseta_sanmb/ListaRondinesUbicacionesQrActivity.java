...
public class ListaRondinesUbicacionesQrActivity extends mx.linkom.caseta_sanmb.Menu{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_rondines_ubi_qr);
        ...
        Incidencia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.RondinIncidenciasQr.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void horarios() {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_qr_2.php";
    ...
    public void rondin(final String id_rondin) {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_qr_3.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void ubicaciones(final String id_app) {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_qr_4.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
        ...
        for (int i = 0; i < ja3.length(); i += 3) {
            try {
               ...
               // String hora = sCadena;
                ...
                ubicacion.add(new ListasHoraFechaClassGrid(ja3.getString(i + 1),"", "ID:"+ja3.getString(i +0)));
            }catch (JSONException e){
                e.printStackTrace();
            }
        }
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.RondinInfoQrActivity.class);
                            startActivity(i);
