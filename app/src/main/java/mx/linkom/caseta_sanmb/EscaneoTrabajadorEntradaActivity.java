...
public class EscaneoTrabajadorEntradaActivity extends mx.linkom.caseta_sanmb.Menu{
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("error")){
                    Conf.setST("Denegado");
                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.AccesosTrabajadorActivity.class);
                    startActivity(i);
                    finish();
                }else {
