...
public class RegTrab2Activity extends mx.linkom.caseta_sanmb.Menu {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Trabajador.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.RegTrabActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void trabajadores() {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/reg_traba4.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.RegTrab3Activity.class);
                            startActivity(i);
                            finish();
                        }
                    });
