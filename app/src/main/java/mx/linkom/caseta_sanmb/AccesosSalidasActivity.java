...
public class AccesosSalidasActivity extends mx.linkom.caseta_sanmb.Menu {
    Configuracion Conf;
    ...
    public void salidas (final String id_visitante){
        String URLResidencial = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_php6.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLResidencial, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    public void Registrar (){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_php7.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void RegistrarHOffline (){
        ...
        try {
            ...
            Log.e("ERR", ja4.getString(2));
            Log.e("ERR", ja4.getString(3));
            Log.e("ERR", ja4.getString(8));
    ...
    public void RegistrarH (){
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_reg_7.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
