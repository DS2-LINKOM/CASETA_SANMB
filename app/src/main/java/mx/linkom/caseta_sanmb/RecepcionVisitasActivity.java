...
public class RecepcionVisitasActivity extends  mx.linkom.caseta_sanmb.Menu{
...
private mx.linkom.caseta_sanmb.Configuracion Conf;
    ...
    public void entradas() {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/visitas_recep_1.php";
    ...
    public void salidas() {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/visitas_recep_2.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            try {
                                ...
                                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.VisitasRecepEntradasDetalle.class);
                                startActivity(i);
                                finish();
