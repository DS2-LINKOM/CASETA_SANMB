...
public class EscaneoVisitaSalidaActivity extends mx.linkom.caseta_sanmb.Menu {
    ...
    public void placas() {
        if (placas.getText().toString().equals("")) {
            ...
            String url = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_php8.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void placas2(final String id_visita) {
        String url = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_php9.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
                    ...
                    try {
                        ...
                        String palabra=sCadena.substring(0, 1);
                         ...
                         if(ja2.getString(5).equals("2") ){
                            ...
                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.AccesosMultiplesSalidasActivity.class);
                            startActivity(i);
                            finish();
                            ...
                            Conf.setST("Aceptado");
                            Conf.setQR(ja2.getString(12));
                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.AccesosSalidasActivity.class);
                            startActivity(i);
                            finish();
                        }
