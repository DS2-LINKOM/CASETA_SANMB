...
public class PlacasInfoActivity extends mx.linkom.caseta_sanmb.Menu{
    ...
    public void RegPlacas(){
        ...
        String url = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/placas_1.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void RegPlacas2(){
        ...
        String url = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/placas_2.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void Visita(final String Id){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_reg_5.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void Usuario(final String IdUsu){
        ...
        String url = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/placas_3.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void dtlLugar(final String idUsuario){
        String url = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/placas_4.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.ReportesActivity.class);
