...
public class RondinIncidenciasQr extends Menu {
    ...
    public void Registrar(final int Id){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/rondines_qr_8.php";
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), ListaRondinesUbicacionesQrActivity.class);
