...
public class EntradasSalidasActivity extends  mx.linkom.caseta_sanmb.Menu {
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            if(position==0) {
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_sanmb.EscaneoVisitaActivity.class);
                                startActivity(docugen);
                                finish();
                            }else if(position==1){
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_sanmb.EscaneoVisitaSalidaActivity.class);
                                startActivity(docugen);
                                finish();
                            }
            ...
            public void onEntrada(Object entrada, View view) {
                if (entrada != null) {
                    ...
                    gridList4.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                           if(position==0){
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_sanmb.EscaneoTrabajadorEntradaActivity.class);
                                startActivity(docugen);
                                finish();
                            }else if(position==1){
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_sanmb.EscaneoTrabajadorSalidaActivity.class);
                                startActivity(docugen);
                                finish();
                            }
                ...
                if (entrada != null) {
                    ...
                    gridList5.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent docugen = new Intent(getApplication(), mx.linkom.caseta_sanmb.RecepcionVisitasActivity.class);
                            startActivity(docugen);
                            finish();
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.DashboardActivity.class);
