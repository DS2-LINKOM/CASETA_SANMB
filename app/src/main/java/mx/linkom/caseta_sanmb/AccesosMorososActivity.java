...
public class  AccesosMorososActivity extends mx.linkom.caseta_sanmb.Menu {
    Configuracion Conf;
    ...
    public void Registrar (){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_php10.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
