...
public class ListaGrupalSalidaActivity extends mx.linkom.caseta_sanmb.Menu {
    ...
    public void invitados() {
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_gru_3.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.AccesosSalidasGrupalActivity.class);
                            startActivity(i);
                            finish();
