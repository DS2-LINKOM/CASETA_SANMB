...
public class PreEntradasGrupalActivity extends mx.linkom.caseta_sanmb.Menu {
...
//ALETORIO3
    ...
    public void Registrar(){
        ...
        if(Placas.getText().toString().equals("") ){
            ...
            String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/vst_php5.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
            RequestQueue requestQueue = Volley.newRequestQueue(this);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
