...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mx.linkom.caseta_sanmb.Global.TOKEN.equals("")) {
            mx.linkom.caseta_sanmb.Global.TOKEN = FirebaseInstanceId.getInstance().getToken();
            Log.d(TAG, "Token Generado: " + mx.linkom.caseta_sanmb.Global.TOKEN);
        }
    ...
    public void Nip() {
        if (Nip.toString().isEmpty()) {
            ...
            String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/pin.php";
    ...
    public void Residencial() {
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/residencial.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void Login() {
        if (User.toString().isEmpty()) {
            ...
            String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/session.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
            RequestQueue requestQueue = Volley.newRequestQueue(this);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (response.length() > 0) {
                        try {
                            ...
                            mx.linkom.caseta_sanmb.Global.USER = ja3.getString(3);
                            mx.linkom.caseta_sanmb.Global.PASS = ja3.getString(4);
                            mx.linkom.caseta_sanmb.Global.EMAIL = ja3.getString(5);


                            Intent i = new Intent(getApplication(), mx.linkom.caseta_sanmb.DashboardActivity.class);
                                startActivity(i);
                                finish();
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("Token", mx.linkom.caseta_sanmb.Global.TOKEN.trim());
    ...
    protected void onStart() {
        ...
        if (ActivityCompat.checkSelfPermission(MainActivity.this, permissions[0]) != PackageManager.PERMISSION_GRANTED) {
            ...
            if(fUser != null){
                ...
                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_sanmb.DashboardActivity.class);
                startActivity(i);
                finish();
