...
public class VisitasRecepEntradasDetalle extends mx.linkom.caseta_sanmb.Menu {
    Configuracion Conf;
    ...
    public void Registrar (final String aprobar){
        ...
        String URL = "https://sanmb.kap-adm.mx/plataforma/casetaV2/controlador/sanmb_access/visitas_recep_3.php";
